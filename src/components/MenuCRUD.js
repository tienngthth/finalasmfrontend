                ...
                <table>
                    ...
                    {dishes.map(el => (
                        <tr key={el.id}>
                            ...
                            <td>
                                <button className={"updateButton"} onClick={() => editFunc(el.id, el.name, el.category, el.description)}>Edit</button>
                            </td>
                            <td>
                                <button className={"deleteButton"} onClick={() => deleteFunc(el.id)}>Delete</button>
                            </td>
                        </tr>
                    ))}
                    </tbody>
